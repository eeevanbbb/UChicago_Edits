...
REPEAT_EDIT_MAX_TIME_MINUTES = 5
...
class WikipediaEdit():
	...
	def is_repeat_of_edit(self, edit):
		return edit is not None and edit.user == self.user and edit.page_title == self.page_title and abs(self.date - edit.date) < datetime.timedelta(minutes=REPEAT_EDIT_MAX_TIME_MINUTES) 
